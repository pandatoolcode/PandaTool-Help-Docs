...
<figure><img src="../.gitbook/assets/TP钱包添加代币.jpg" alt=""><figcaption></figcaption></figure>

如果输入合约地址找不到，还可以通过自定义代币添加。点击自定义代币，然后点击添加，输入合约地址，就会自动匹配了

<figure><img src="../.gitbook/assets/TP钱包自定义代币.jpg" alt=""><figcaption></figcaption></figure>

### 2、欧易Web3钱包

OKX Web3钱包添加代币的流程与TP差不多，直接在钱包页面点击添加，搜索合约地址就可以了

<figure><img src="../.gitbook/assets/OKX钱包添加代币.jpg" alt=""><figcaption></figcaption></figure>

### 3、波宝钱包TronLink

波宝钱包TronLink是专注于波场链的钱包，其页面UI与TP类似，添加代币的方式主要如下图所示

<figure><img src="../.gitbook/assets/波宝钱包.jpg" alt=""><figcaption></figcaption></figure>
