...
首先，我们打开PumpFun发币链接：[https://solana.pandatool.org/createpump](https://solana.pandatool.org/createpump)，点击右上角“选择钱包”
...
目前平台最多支持**13个地址**捆绑买入，每个地址捆绑收费0.05sol，**捆绑费由主钱包收取**
...
<mark style="color:blue;">注意：在输入买入金额后，必须确保连接的钱包内有</mark><mark style="color:blue;">**足够的SOL**</mark><mark style="color:blue;">用于支付捆绑费用</mark>
{% endhint %}

<figure><img src="../.gitbook/assets/pump买入金额.jpg" alt=""><figcaption></figcaption></figure>
...
**1、最多捆绑13个地址，包不包括发币地址？**

* **答：**&#x4E0D;包括，连同发币地址，最多可支持14个地址在开盘时买入代币
