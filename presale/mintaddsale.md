...
<figure><img src="../.gitbook/assets/1链接钱包 (5).png" alt=""><figcaption></figcaption></figure>

之后会弹出小狐狸让你确定要连接的钱包地址，选择一个就行了。然后下一步就是选择公链，如果您要在币安创建预售，就选择BSC。如果要在Base链创建预售，就选择Base

<figure><img src="../.gitbook/assets/2选择公链 (1).png" alt=""><figcaption></figcaption></figure>

之后就能在右上角看到你的钱包地址和链状态，说明已经链接成功了

### 2、填写预售参数

钱包连接成功后，我们通过PandaTool可视化页面创建预售，还是那个页面：[https://www.pandatool.org/zh-CN/presale](https://www.pandatool.org/zh-CN/presale)  打开，选择**Mint加池**模式

<figure><img src="../.gitbook/assets/3选择Mint加池.png" alt=""><figcaption></figcaption></figure>
...
和标准Mint不同的是，**Mint加池**模式，还需要选择交易所和加池比例

<figure><img src="../.gitbook/assets/4交易所和加池比例.png" alt=""><figcaption></figcaption></figure>

* [x] **选择交易所：**&#x42;SC的选择Pancake，Base链的选择Uniswap
* [x] **加池比例：**&#x6309;照设定的比例（最小50%，最大100%）添加流动性，多余的BNB或者ETH给到营销钱包（默认是发币钱包）

{% hint style="info" %}
假设设置50%的加池比例，每份价格0.1BNB、每份1000枚代币。当用户Mint 1份，支付了0.1BNB之后，其中0.05BNB会和500枚代币一起添加到流动性。那么还有0.05BNB和500枚代币怎么办呢？其中，0.05BNB会给到项目方营销钱包，而500枚代币会给回到用户。那么用户获得的就是：500枚代币+一部分LP
{% endhint %}

参数填写完成后，点击创建合约

<figure><img src="../.gitbook/assets/5创建合约 (1).png" alt=""><figcaption></figcaption></figure>

此时会弹出钱包进行确认，等待几秒，就会提示你预售创建完成

<figure><img src="../.gitbook/assets/6创建成功 (1).png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/7预售控制台 (1).png" alt=""><figcaption></figcaption></figure>
...
* [x] **加池比例怎么理解？**
  ...
  * 至于用户呢，他会获得一半的代币和一部分的LP
  * 如果你选择100%，那么用户将不再获得代币，只获得LP
* [x] **营销钱包有什么用？**
